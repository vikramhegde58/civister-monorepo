...
import { ArrowLeft, Palette, Sparkles, CheckCircle2, ArrowRight } from "lucide-react";
      ...
      <section className="py-16 sm:py-24 md:py-32 bg-background border-y border-gray-200">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6">
          <FadeIn>
            ...
            <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">This intelligent design tool is currently in development</p>
          </FadeIn>
          ...
          <Card className="border-2 border-dashed border-gray-300 max-w-4xl mx-auto">
            <CardHeader>
              ...
              <CardDescription>
                Here's what you'll be able to do with our Interior Generator:
              </CardDescription>
            </CardHeader>
